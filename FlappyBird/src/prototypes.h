...
extern int drawImage(SDL_Texture *texture,int x, int y);
...
extern void gravite(Input *in,float factGravite, float factSautMaintenu);
extern void controllSol(void);
extern void saute(float impulsion);
